...
namespace OWC {
    class KeySlotV2Widget final: public QWidget {
        Q_OBJECT
    ...
    public:
        explicit KeySlotV2Widget(int slotNum);
        ...
        void setHoldTime(const int time) const { holdTime->setValue(time); }
        [[nodiscard]] int getHoldTime() const { return holdTime->value(); }
